...
class TenantAddressHistory(Base):
    ...
    landlord_first_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    landlord_middle_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    landlord_last_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
...
class TenantEmployment(Base):
    ...
    employer_reference_first_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    employer_reference_middle_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    employer_reference_last_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
