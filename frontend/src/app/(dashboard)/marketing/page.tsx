...
import { campaignsApi, unitsApi, imagesApi, type CampaignOut, type CampaignStatus, type UnitDetailOut, type ImageOut, type MarketingSiteOut } from "@/lib/api";
...
function CampaignModal({
  campaign, units, onClose, onSave, onPhotosChanged, onDelete,
}: {
