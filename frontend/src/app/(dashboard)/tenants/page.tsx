...
const MOCK_PERSONS: PersonRow[] = [
  {
    ...
    leases: [{
      ...
      notes: null, tenant: null, co_tenants: [], landlord_name: null, unit_number: "101", property_name: "Sunset Towers",
    }],
    currentLease: {
      id: "l1", unit_id: "u1", tenant_user_id: "tu1", start_date: "2026-02-01",
      end_date: "2027-01-31", monthly_rent: 2400, security_deposit: 2400,
  ...
  },
  {
    ...
    leases: [{
      ...
      notes: null, tenant: null, co_tenants: [], landlord_name: null, unit_number: "103", property_name: "Sunset Towers",
    }],
    currentLease: null,
  },
];
