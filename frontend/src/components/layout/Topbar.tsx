    ...
    <>
      <header className="h-12 bg-black flex items-center px-4 gap-6 shrink-0 z-40">
        ...
        <Link href="/dashboard" className="flex items-center gap-2 shrink-0">
          <div className="w-6 h-6 rounded bg-white flex items-center justify-center text-black font-bold text-[12px] leading-none">
            PC
          </div>
          <div className="hidden sm:block">
            <p className="text-white text-xs font-semibold leading-none">PropertyCopilot</p>
            <p className="text-white/40 text-[12px] leading-none mt-0.5">AI property operations</p>
          </div>
        </Link>
